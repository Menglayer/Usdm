      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
            Three layers. One dollar. <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400">Infinite potential.</span>
          </h2>
        ...
        >
          <motion.div variants={modelVariants} className="relative w-[300px] h-[300px] md:w-[400px] md:h-[400px]">
            ...
            <button 
              ...
              onMouseLeave={() => setHoveredLayer(null)}
            >
              <h3 className={cn("font-bold tracking-widest uppercase text-center transition-colors text-[10px] md:text-xs", hoveredLayer === 'inner' || !hoveredLayer ? "text-cyan-200" : "text-white/30")}>
                RWA
                <br />
                Foundation
              </h3>
        ...
        >
          ...
          <motion.div 
            ...
            className={cn(
              ...
              hoveredLayer === 'outer' ? "border-violet-500/50 bg-violet-950/20 shadow-[0_0_30px_rgba(139,92,246,0.15)]" : "border-white/5 hover:border-white/10"
            )}
            onMouseEnter={() => setHoveredLayer('outer')}
            onMouseLeave={() => setHoveredLayer(null)}
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">DeFi Shell</h3>
            <p className="text-white/60 mb-6 min-h-[60px]">
              Pendle YT/PT positions, Curve LPs, and Morpho Vaults. The high-yield compounding layer.
            </p>
            <div className="flex justify-between items-center pt-6 border-t border-white/5">
              <div>
                <span className="text-xs text-white/40 uppercase block mb-1">APY Range</span>
                <span className="text-violet-400 font-mono font-bold">8% - 15%</span>
              </div>
              <div>
                <span className="text-xs text-white/40 uppercase block mb-1 text-right">Risk Level</span>
                <span className="text-white/80 font-medium text-right block">Medium</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className={cn(
              "glass p-8 rounded-3xl border transition-all duration-500 relative overflow-hidden",
              hoveredLayer === 'middle' ? "border-indigo-500/50 bg-indigo-950/20 shadow-[0_0_30px_rgba(99,102,241,0.15)]" : "border-white/5 hover:border-white/10"
            )}
            onMouseEnter={() => setHoveredLayer('middle')}
            onMouseLeave={() => setHoveredLayer(null)}
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">CeFi Core</h3>
            <p className="text-white/60 mb-6 min-h-[60px]">
            ...
            <div className="flex justify-between items-center pt-6 border-t border-white/5">
              ...
              <div>
                <span className="text-xs text-white/40 uppercase block mb-1 text-right">Risk Level</span>
                <span className="text-white/80 font-medium text-right block">Low/Med</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className={cn(
              "glass p-8 rounded-3xl border transition-all duration-500 relative overflow-hidden",
              hoveredLayer === 'inner' ? "border-cyan-500/50 bg-cyan-950/20 shadow-[0_0_30px_rgba(6,182,212,0.15)]" : "border-white/5 hover:border-white/10"
            )}
            onMouseEnter={() => setHoveredLayer('inner')}
            onMouseLeave={() => setHoveredLayer(null)}
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">RWA Foundation</h3>
            <p className="text-white/60 mb-6 min-h-[60px]">
            ...
            <div className="flex justify-between items-center pt-6 border-t border-white/5">
              ...
              <div>
                <span className="text-xs text-white/40 uppercase block mb-1 text-right">Risk Level</span>
                <span className="text-white/80 font-medium text-right block">Lowest</span>
              </div>
            </div>
          </motion.div>
        </motion.div>
